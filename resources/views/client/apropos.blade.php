...
<html>
   ...
   <body class="sub_page">
      ...
      <section class="why_section layout_padding">
         <div class="container">
            <div align="center">
               <h1 style="display: inline-flex;"> <p style="color:black; font-weight: bold;">Play&</p><p style="color:gold; font-weight: bold;">Shop</p></h1> 
            <p>La satisfaction du client et l'expérience utilisateur sont deux points très importants auxquels nous tenons énormement. C'est cette conviction qui donne tout le sens de la plateforme Play&Shop. Avec Play&Shop c'est faire des achats et ressortir heureux!</p>
            </div>
            
            <div class="heading_container heading_center">
               <h2>
                  Achetez avec nous c'est bénéficier de:
               </h2>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                          Nous vous livrons vos produit en un temps record
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           Notre plateforme est conçue pour simplifier vos achats 
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           Nous selectionnons les produits de haute qualité pour vous rendre heureux!
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        <h5>
                           Une réduction  sans pareil
                        </h5>
                        <p>
                           Nous travaillons toujours pour que les prix soient à la porté de tout nos clients!
                        </p>
                     </div>
                  </div>
               </div>
