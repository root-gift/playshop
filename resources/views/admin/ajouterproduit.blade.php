            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Produit</h4>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="input-group input-group-outline mb-3">
                      {!!Form::label('', 'Nom du produit', ['for' =>'cname', 'class' => 'form-label'])!!}
                      {!!Form::text('product_name', '', ['id' => 'cname', 'class' => 'form-control'])!!}
                  </div>
                  <div class="input-group input-group-outline mb-3">
                      {!!Form::label('', 'Prix du produit', ['for' =>'cname', 'class' => 'form-label'])!!}
                      {!!Form::number('product_price','', ['id' => 'cname', 'class' => 'form-control'])!!}
                  </div>
                  <div class="input-group input-group-outline mb-3">
                      {!!Form::label('', '',['for' =>'cname', 'class' => 'form-label'])!!}
                      {!!Form::select('product_category',$categories, null, ['placeholder' => 'selectionner la categorie', 'class' => 'form-control'])!!}
                  </div>
                  <div class="input-group input-group-outline mb-3">
                    {!!Form::label('', 'quantité', ['for' =>'cname', 'class' => 'form-label'])!!}
                    {!!Form::number('product_qte', '', ['id' => 'cname', 'class' => 'form-control'])!!}
                  </div>
                  <div class="input-group input-group-outline mb-3">
                      {!!Form::label('', '', ['for' =>'cname', 'class' => 'form-label'])!!}
